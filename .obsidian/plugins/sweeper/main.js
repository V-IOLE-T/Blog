...
var SweeperSettingsTab = class extends import_obsidian2.PluginSettingTab {
  ...
  display() {
    ...
    new import_obsidian2.Setting(containerEl).setName("保存时清理").setDesc("按下 Cmd/Ctrl+S 时清理 Markdown").addDropdown(
    ...
    new import_obsidian2.Setting(containerEl).setName("粘贴时清理").setDesc("清理从剪贴板粘贴的纯文本").addDropdown(
    ...
    new import_obsidian2.Setting(containerEl).setName("预设").setDesc("快速选择规则集，之后仍可单独开关各条规则。").addDropdown((dropdown) => {
